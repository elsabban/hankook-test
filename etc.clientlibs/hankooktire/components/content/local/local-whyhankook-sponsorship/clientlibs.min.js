...
function main() {
  ...
  // });
    ...
    const hasIframe = document.querySelectorAll('.lws .pic iframe').length !== 0;
    ...
    const swiperSponsorship = new (external_Swiper_default())(".lws .mySwiper", {
      slidesPerView: "auto",
      //loop: true,
      spaceBetween: 12,
      breakpoints: { 
      ...
      navigation : {
        nextEl: '.lws .swiper-button-next',
        prevEl: '.lws .swiper-button-prev',
      },
      on: {
        transitionStart: function(){
          if ($('.lws video').length > 0){
            var lwsvideos = document.querySelectorAll('.lws video');
    
            Array.prototype.forEach.call(lwsvideos, function(video){
              video.pause();
            });
          };          
        ...
        init : () => {
          if (document.querySelectorAll('.lws .swiper-slide').length <= 1) {
            document.querySelector('.lws .swiper-button-next').classList.add('hidden')
            document.querySelector('.lws .swiper-button-prev').classList.add('hidden')
          }
        },
        ...
        transitionEnd: function(){
          if ($('.lws video').length > 0){
            ...
            var activeSlide = $('.lws .swiper-slide')[activeIndex];
